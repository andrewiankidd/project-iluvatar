...
slug: guides/netbooting-raspberry-pi/pi-boot
...
<video controls width="100%" title="First Boot">
    <source src="/project-iluvatar/assets/docs/guides/bootstrap/prep/first-boot.mp4" type="video/mp4">
...
Hacking at the extracted filesystem feels like a good exploratory exercise, but isn't something I'd like to rely to work on long term. Preferrably I could get a declaritive OS like Nix or TalOS going, but at this time they are not supported by the Pi 5.

In the meantime, we can at least use an OS that supports some declaritive config.
